import { animate, sequence, stagger } from '@underlying/core'
import { button, h, type Section } from '../showcase'

export const composition: Section = {
  id: 'composition',
  group: 'Composition',
  title: 'Stagger & sequence',
  ...
  description: `
    ...
    fixed delay - a cascade. <code>sequence</code> runs steps strictly in order,
  ...
  code: `import { animate, stagger, sequence } from '@underlying/core'
...
sequence(steps: Array<() => AnimationHandle>): AnimationHandle`,
  run(ctx) {
