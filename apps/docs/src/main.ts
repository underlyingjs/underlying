...
import { carousel, gestures, pointerMagnetic, pointerTilt, setRelease, unifiedInput } from './sections/gestures'
...
const pages: Page[] = [
  ...
  },
  {
    ...
    sections: [gestures, pointerTilt, pointerMagnetic, carousel, unifiedInput, setRelease],
  },
  {
    id: 'composition',
    group: 'Guides',
