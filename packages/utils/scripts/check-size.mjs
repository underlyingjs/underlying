// Enforces the @underlying/utils size budget on the built ESM entry (gzip,
...
const full = await probe(`import * as utils from './index.js'\nconsole.log(utils)`)
check('@underlying/utils (full surface)', full, FULL_BUDGET_BYTES)
