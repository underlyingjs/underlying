// Enforces the @underlying/gestures size budget on the built ESM bundle (gzip,
...
const full = await probe(`import * as gestures from './index.js'\nconsole.log(gestures)`)
check('@underlying/gestures (full surface)', full, FULL_BUDGET_BYTES)
