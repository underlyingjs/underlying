...
- fb77271: Awaitable handles + playhead queries (#70).
...
- 7aafc87: Declarative entrances on `animate()` (#41): `from()` and `fromTo()`.
...
- 5bebad9: Keyframe expressivity + `filter()` / attribute / `autoAlpha` channels (#56).
